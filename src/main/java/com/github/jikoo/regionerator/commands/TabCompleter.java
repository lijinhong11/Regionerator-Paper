...
public class TabCompleter {
    ...
    public static @NotNull List<String> completeEnum(
            @NotNull String argument, @NotNull Class<? extends Enum<?>> enumClazz) {
     ...
     */
    public static @NotNull List<String> completeString(@NotNull String argument, @NotNull String @NotNull [] options) {
        argument = argument.toLowerCase(Locale.ENGLISH);
        List<String> completions = new ArrayList<>();
    ...
    public static <T> @NotNull List<String> completeObject(
            @NotNull String argument, @NotNull Function<T, String> converter, @NotNull T @NotNull [] options) {
        argument = argument.toLowerCase(Locale.ENGLISH);
        List<String> completions = new ArrayList<>();
