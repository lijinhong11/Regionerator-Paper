...
public enum AccessMode {
    ...
    WRITE_SYNC("rws", new OpenOption[] {
        StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.SYNC
    }),
    /** {@link #WRITE} with all writes to the file being synchronized with the underlying storage. */
    WRITE_DSYNC("rwd", new OpenOption[] {
        StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.DSYNC
    });
